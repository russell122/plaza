...
var mainProductTabsSection = document.querySelector('.best-products-section');
var mainProductTabsHeader = mainProductTabsSection.querySelector('.best-products__tabs-header');
var mainProductTabsButtons = mainProductTabsHeader.querySelectorAll('.best-products__tabs-button');
var mainProductTabsBody = mainProductTabsSection.querySelector('.best-products__tabs-content');
var mainProductTabsSliders = mainProductTabsBody.querySelectorAll('.tab-slider__wrapper');
var activeMainProductTabsButton = mainProductTabsButtons[0].dataset.tabHeader;
var activeMainProductTabsSlider = mainProductTabsSliders[0].dataset.tabBody;
var bestProductSlider = document.querySelector('.product-tab__swiper-container');
var saleProductSlider = document.querySelector('.sale-tab__swiper-container');
var newProductSlider = document.querySelector('.new-tab__swiper-container');
var bestNext = document.querySelector('.products-slider__control-button_next-best');
var bestPrev = document.querySelector('.products-slider__control-button_prev-best');
var saleNext = document.querySelector('.products-slider__control-button_next-sale');
var salePrev = document.querySelector('.products-slider__control-button_prev-sale');
var newNext = document.querySelector('.products-slider__control-button_next-new');
var newPrev = document.querySelector('.products-slider__control-button_prev-new');
var brandsSlider = document.querySelector('.brands-slider__wrapper');
var brandNext = document.querySelector('.brands-controls__button_next');
var brandPrev = document.querySelector('.brands-controls__button_prev');
mainProductTabsButtons.forEach(function (button) {
  button.addEventListener('click', function (e) {
    mainProductTabsButtons.forEach(function (missedButton) {
      return missedButton.classList.remove('active');
    });
    activeMainProductTabsButton = e.target.dataset.tabHeader;

    if (button.dataset.tabHeader === activeMainProductTabsButton) {
      button.classList.add('active');
    }

    mainProductTabsSliders.forEach(function (slider) {
      slider.classList.add('hidden');

      if (slider.dataset.tabBody === activeMainProductTabsButton) {
        activeMainProductTabsSlider = activeMainProductTabsButton;
        slider.classList.remove('hidden');
      }
    });
  });
});
var bannerSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.banners__slider', {
  direction: 'horizontal',
  loop: true
});
var bannerSliderNext = document.querySelector('.banners-slider__button_next');
var bannerSliderPrev = document.querySelector('.banners-slider__button_prev');
bannerSliderNext.addEventListener('click', function () {
  return bannerSlider.slideNext();
});
bannerSliderPrev.addEventListener('click', function () {
  return bannerSlider.slidePrev();
});
...
function initSlider(slider, next, prev) {
  ...
  var initedSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
    ...
    spaceBetween: slider.classList.contains('brands-slider__wrapper') ? 40 : 0,
    observer: true,
    observeParents: true
  });
...
initSlider(bestProductSlider, bestNext, bestPrev);
initSlider(saleProductSlider, saleNext, salePrev);
initSlider(newProductSlider, newNext, newPrev);
initSlider(brandsSlider, brandNext, brandPrev); // const brandSlider = new Swiper('.brands-slider__wrapper', {
//     // autoHeight: true,
//     slidesPerView: 1,
//     loop: true,
//     // navigation: {
