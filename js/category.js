...
if (window.innerWidth > 1024) {
  var popularBanner = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.popular-slider', options);
} else {
  var _popularBanner = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.popular-slider_mobile', options);
}
...
function setLeftValue() {
  ...
  priceFrom.value = "".concat(_this.value * 1);
...
function setRightValue() {
  ...
  priceTo.value = "".concat(_this.value * 1);
  var percent = (_this.value - min) / (max - min) * 100;
