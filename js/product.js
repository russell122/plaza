...
/* harmony import */ var _css_loader_dist_cjs_js_magnific_popup_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !../../css-loader/dist/cjs.js!./magnific-popup.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/magnific-popup/dist/magnific-popup.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_magnific_popup_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ __webpack_exports__["default"] = (_css_loader_dist_cjs_js_magnific_popup_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony default export */ __webpack_exports__["default"] = (_css_loader_dist_cjs_js_swiper_min_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var magnific_popup_dist_jquery_magnific_popup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! magnific-popup/dist/jquery.magnific-popup.js */ "./node_modules/magnific-popup/dist/jquery.magnific-popup.js");
/* harmony import */ var magnific_popup_dist_jquery_magnific_popup_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(magnific_popup_dist_jquery_magnific_popup_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var magnific_popup_dist_magnific_popup_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! magnific-popup/dist/magnific-popup.css */ "./node_modules/magnific-popup/dist/magnific-popup.css");




var productTabsSection = document.querySelector('.product-section');
var productTabsHeader = productTabsSection.querySelector('.tab-header__list');
var productTabsButtons = productTabsHeader.querySelectorAll('.tab-header__list-button');
var productTabsBody = productTabsSection.querySelector('.product-tab__body');
var productTabsSliders = productTabsBody.querySelectorAll('.product-tab');
var activeProductTabsButton = productTabsButtons[0].dataset.tabHeader;
var activeProductTabsSlider = productTabsSliders[0].dataset.tabBody;
var otherSlider = document.querySelector('.other-card__swiper-container');
var otherNext = document.querySelector('.other-slider__button_next');
var otherPrev = document.querySelector('.other-slider__button_prev');
var similarSlider = document.querySelector('.similar-card__swiper-container');
var similarNext = document.querySelector('.similar-slider__button_next');
var similarPrev = document.querySelector('.similar-slider__button_prev');
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Autoplay"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_0__["Thumbs"], swiper__WEBPACK_IMPORTED_MODULE_0__["Zoom"]]);
productTabsButtons.forEach(function (button) {
  button.addEventListener('click', function (e) {
    productTabsButtons.forEach(function (missedButton) {
      return missedButton.classList.remove('active');
    });
    activeProductTabsButton = e.target.dataset.tabHeader;

    if (button.dataset.tabHeader === activeProductTabsButton) {
      button.classList.add('active');
    }

    productTabsSliders.forEach(function (slider) {
      slider.classList.add('hidden');

      if (slider.dataset.tabBody === activeProductTabsButton) {
        activeProductTabsSlider = activeProductTabsButton;
        slider.classList.remove('hidden');
      }
    });
  });
});
var counterWrapper = document.querySelector('.product-total__counter-wrapper');
var counterDecreaseButton = counterWrapper.querySelector('.product-total__counter-button_decrease');
var counterIncreaseButton = counterWrapper.querySelector('.product-total__counter-button_increase');
var counterValueWrapper = counterWrapper.querySelector('.product-total__counter-value');
var priceWrapper = document.querySelector('.product-total__total-price');
var totalValueWrapper = document.querySelector('.product-total__total-value');
var counterValue = +counterValueWrapper.innerText;
counterDecreaseButton.addEventListener('click', function () {
  if (counterValue > 0) {
    counterValue--;
    counterValueWrapper.innerText = counterValue;
  }

  setTotalValue();
});
counterIncreaseButton.addEventListener('click', function () {
  counterValue++;
  counterValueWrapper.innerText = counterValue;
  setTotalValue();
});
...
function setTotalValue() {
  totalValueWrapper.innerText = counterValue * parseInt(priceWrapper.innerText) + ' ₽';
}
...
function initSlider(slider, next, prev) {
  ...
  var initedSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
    loop: true,
  ...
  next.addEventListener('click', function () {
    return initedSlider.slideNext();
  });
  prev.addEventListener('click', function () {
    return initedSlider.slidePrev();
  });
}

initSlider(otherSlider, otherNext, otherPrev);
initSlider(similarSlider, similarNext, similarPrev); // Swiper.use([Autoplay, Pagination]);
